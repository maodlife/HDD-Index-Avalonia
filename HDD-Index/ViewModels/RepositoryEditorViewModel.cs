...
public class RepositoryEditorViewModel : ViewModelBase
{
    ...
    public ReactiveCommand<Unit, Unit> RepairCurrentFileDataPathCommand { get; set; }
        = ReactiveCommand.Create(() => { });
    ...
    public ReactiveCommand<object, Unit> RefreshFileNodeFromLocalFolderSkippingDeclaredCommand { get; set; }
        = ReactiveCommand.Create<object>(_ => { });
