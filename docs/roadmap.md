...
| P5 | 应用编排边界重构 | 实施中 | P5.1 至 P5.4 已完成；下一切片为 P5.5 Repository 编辑用例 |
...
**状态：实施中（2026-07-28 开始；P5.1 至 P5.4 已完成）**

P5.1 已将文件扫描从 `FileNode` 提取到独立边界，P5.2 隔离了外部交互，P5.3
建立了共享会话与持久化边界，P5.4 提取了声明持有用例。当前剩余的主要压力集中在
`MainWindowViewModel`：它仍负责 Repository 和 File Tree 的大量命令编排；
