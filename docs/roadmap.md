...
| P5 | 应用编排边界重构 | 待合入 | P5.1 至 P5.6 已实现；P5.6 File Tree 编辑用例与收尾正在通过 PR 集成 |
...
**状态：待合入（2026-07-28 开始；P5.1 至 P5.6 已实现）**
...
| P5.6 | File Tree 编辑用例与收尾 | 待合入 | 提取刷新、新建、删除和路径操作，让主 ViewModel 收敛为窗口壳层 |
